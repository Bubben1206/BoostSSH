...
int main()
{
	...
	string privkey;
	string pubkey = keygenRSA(256, privkey);

	string publickeyfilePath = "keys/publickey.txt";
	string privatekeyfilePath = "keys/privatekey.txt";

	ofstream publickey(publickeyfilePath);
	...
	ofstream privatekey(privatekeyfilePath);
